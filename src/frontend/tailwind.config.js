  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        /* YojnaAI brand colors */
        "yojna-purple": "#6C5CE7",
        "yojna-cyan": "#00D4FF",
        "yojna-bg": "#0B0F1A",
        "yojna-card": "rgba(255,255,255,0.04)",
      },
      fontFamily: {
      ...
      boxShadow: {
        ...
        glow: "0 0 30px rgba(108, 92, 231, 0.3), 0 0 80px rgba(108, 92, 231, 0.1)",
        "glow-cyan": "0 0 30px rgba(0, 212, 255, 0.3), 0 0 80px rgba(0, 212, 255, 0.1)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      fontSize: {
        ...
        "subheading": ["1.75rem", { lineHeight: "1.3", fontWeight: "600" }],
      },
    },
  },
